...
@section('panel')
    <div class="panel-heading container-fluid">
        <div class="form-group">
            <a class="btn btn-info btn-xs col-md-1 col-sm-2 col-xs-2" href="{{route('socialPeoples.index')}}">
                <i class="fa fa-backward" aria-hidden="true"></i> back
            </a>
            <div class="centered-child col-md-9 col-sm-7 col-xs-6">SocialPeoples: <b>{{$socialPeople->name}}</b></div>
            <div class="col-md-2 col-sm-3 col-xs-4">
                <div class="pull-right">
                    {{Form::open(['class' => 'confirm-delete', 'route' => ['socialPeoples.destroy', $socialPeople->id], 'method' => 'DELETE'])}}
                    {{ link_to_route('socialPeoples.edit', 'edit', [$socialPeople->id], ['class' => 'btn btn-primary btn-xs']) }} |
